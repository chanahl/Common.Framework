...
namespace Common.Automation.Deployment.Applications
{
    public abstract class Application<TDeploymentInfo> where TDeploymentInfo : DeploymentInfo
    {
        ...
        protected virtual bool ExecuteOperation()
        {
            ...
            {
                var process = new Framework.Core.System.Process(ProcessStartInfo, processName);
            ...
            else
            {
                ...
                var process = new Framework.Core.System.Process(ProcessStartInfo, processName, logFile);
                processStatus = process.Start(DeploymentInfo.TimeoutInMinutes);
            }
